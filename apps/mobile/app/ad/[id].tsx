...
const COPY: Record<Locale, {
  ...
  de: {
    ...
    premiumLockDesc: 'Das Kontaktieren von Kandidaten ist Premium-Mitgliedern vorbehalten.',
    premiumCta: 'Mehr erfahren',
    match: 'Match',
    topMatch: 'Top Match',
  ...
  en: {
    ...
    premiumLockDesc: 'Contacting candidates is available to Premium members.',
  ...
  fr: {
    ...
    edit: 'Modifier',
    premiumLockTitle: 'Fonctionnalité Premium',
    premiumLockDesc: 'Le contact des candidats est réservé aux membres Premium.',
    premiumCta: 'En savoir plus',
    match: 'Match',
    topMatch: 'Top Match',
  ...
  it: {
    ...
    edit: 'Modifica',
    premiumLockTitle: 'Funzione Premium',
    premiumLockDesc: 'Il contatto con i candidati è riservato ai membri Premium.',
    premiumCta: 'Scopri di più',
    match: 'Match',
    topMatch: 'Top Match',
  ...
  sq: {
    ...
    edit: 'Ndrysho',
    premiumLockTitle: 'Funksion Premium',
    premiumLockDesc: 'Kontaktimi i kandidatëve është për anëtarët Premium.',
    premiumCta: 'Mëso më shumë',
    match: 'Përputhje',
